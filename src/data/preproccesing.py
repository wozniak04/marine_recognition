...
from src.utils.geo import calc_traveled_distance, calc_course
...
class DataPreprocessor:
    ...
    def _gps_find_outliers(self, frame: pd.DataFrame) -> pd.DataFrame:
        ...
        # Summary
        self.logger.info(f"Wykryto łącznie: {(frame['is_outlier'] == 1).sum()} outlierów.")
    ...
    def _mark_drift(self, frame: pd.DataFrame) -> pd.DataFrame:
        ...
        self.logger.info(f"Wykryto {drift_sum} statków dryfujących.")
