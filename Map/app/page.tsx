      ...
      try {
        ...
        Papa.parse(csvString, {
          ...
          complete: (results) => {
            ...
            // Jeśli danych jest bardzo dużo (np. 200k), możemy je ograniczyć dla wydajności przeglądarki
            // Zmniejszamy próbkowanie dla lepszej widoczności poszczególnych punktów (co 20 punkt zamiast 50)
            const sampledData = validData.filter((_, index) => index % 20 === 0);
    ...
    <div className="flex flex-col min-h-screen bg-zinc-50 font-sans dark:bg-black">
      <main className="flex flex-1 flex-col p-8 md:p-16">
        ...
        <div className="mt-8 text-sm text-zinc-500 flex justify-between">
          <span>Załadowano {data.length} punktów trasy (próbkowanie 1:20).</span>
